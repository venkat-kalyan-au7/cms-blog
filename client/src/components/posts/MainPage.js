    ...
    return (
        <div className="main-page-container">
            ...
            <AllPosts posts={posts} />
            {
                ...
                <Link to="/create/post"><span className="btn-floating btn-large waves-effect waves-light red add-btn  #42a5f5 blue lighten-1"><i className="material-icons">ADD POST</i></span></Link>
                </div> : ''
            }
        </div>
    )
