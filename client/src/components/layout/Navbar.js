...
const Navbar = ({ auth: {isAuthenticated, loading}, logout }) => {
    ...
    const authLink = (
        <Fragment>
            ...
            <li><span style={{margin: '0 1rem',cursor: 'pointer'}} onClick={logout}><i class="sign-out icon"></i></span></li>
        </Fragment>
    )
    ...
    return (
        <nav className="nav-spacing #42a5f5 blue lighten-1">
            <div className="nav-wrapper">
                <span href="#!" className="brand-logo left"><Link to="/">
                <i class="blogger icon"></i>
                    </Link></span>
                <span href="#!" data-target="mobile-demo" className="sidenav-trigger right"><i class="align justify icon"></i></span>
